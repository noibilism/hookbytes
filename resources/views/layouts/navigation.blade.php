    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('dashboard.events')" :active="request()->routeIs('dashboard.events')">
                <i class="fas fa-bolt mr-2"></i> {{ __('Events') }}
            </x-responsive-nav-link>
            ...
            <x-responsive-nav-link :href="route('dashboard.api-docs')" :active="request()->routeIs('dashboard.api-docs')">
                <i class="fas fa-book mr-2"></i> {{ __('API Docs') }}
            </x-responsive-nav-link>
        </div>
